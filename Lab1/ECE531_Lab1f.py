...
class ECE531_Lab1f(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ECE531_Lab1f")
        ...
        # Variables
        ##################################################
        self.sample_rate = sample_rate = 10000
        self.phase = phase = 0
        ...
        self._magnitude_range = Range(0, 1, .1, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(sample_rate, analog.GR_SIN_WAVE, freq, 1, 0, 0)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, .05, 0)
        ...
        self.connect((self.channels_iqbal_gen_0, 0), (self.qtgui_time_sink_x_1, 0))
...
def main(top_block_cls=ECE531_Lab1f, options=None):
