...
class ECE531_Lab1c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ECE531_Lab1c")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(sample_rate, analog.GR_SIN_WAVE, frequency, 1, 0, 0)
...
def main(top_block_cls=ECE531_Lab1c, options=None):
